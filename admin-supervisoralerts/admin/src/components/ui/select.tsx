...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      error && "border-red-500", // Apply red border when error prop is true
      className
    )}
    {...props}
  >
...
//   }
// >(({ className, children, error, placeholderClassName, ...props }, ref) => (
//   <SelectPrimitive.Trigger
//     ref={ref}
//     className={cn(
...
//       <div className={cn("flex-1 truncate", placeholderClassName)}>{children}</div>
//       <SelectPrimitive.Icon asChild>
