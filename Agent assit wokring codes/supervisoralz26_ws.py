...
async def handle_connection(websocket, path):
    ...
    try:
        ...
        if "/transcripts" in path:
            # ✅ FIX: properly read ?agentId or ?supervisorId query parameters
            ...
            if supervisor_id:
                ...
                await websocket.close(code=1008, reason="Missing agentId or supervisorId")
            return

        # otherwise it's an audio leg
